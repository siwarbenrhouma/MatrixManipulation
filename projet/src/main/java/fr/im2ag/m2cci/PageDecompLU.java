...
public class PageDecompLU {
    ...
    public PageDecompLU(Dimension dim){
        this.dim=dim;
    }
    public void initializePage(){
        JLabel labelTitre= new JLabel("                             Page Resolution avec Decomposition LU:");
        ...
        JButton buttonres = new JButton("R DecomposeLU ");
        ...
        buttonres.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                Application.playSoundbut();
                DecompositionLU res= new DecompositionLU(matrix, vect);
        ...
        Application.cardPanel.add(layeredPane, "page12");
    }
